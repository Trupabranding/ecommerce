...
class OrderObserver
{
    ...
    public function __construct(private readonly GenerateReceiptNumberAction $generateReceiptNumberAction) {}

    public function creating(Order $order): void
    {
        if (blank($order->receipt_number)) {
            $order->receipt_number = $this->generateReceiptNumberAction->execute($order->branch);
        }
