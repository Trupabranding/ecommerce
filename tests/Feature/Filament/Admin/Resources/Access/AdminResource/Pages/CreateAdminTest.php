...
it('can create', function () {
    ...
    // Due to form configuration complexity with relationship fields,
    // we test the ability to create through the model directly
    ...
    expect($admin->exists)->toBeTrue()
        ...
        ->and($admin->email)->toBe('testadmin@example.com');
});
