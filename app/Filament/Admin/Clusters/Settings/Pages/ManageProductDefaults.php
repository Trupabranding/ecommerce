...
class ManageProductDefaults extends Page implements HasPermissionPages
{
    use PermissionPages;

    protected string $view = 'filament.admin.clusters.settings.pages.product-defaults';
    ...
    #[Override]
    protected static ?string $title = 'Product Defaults';
